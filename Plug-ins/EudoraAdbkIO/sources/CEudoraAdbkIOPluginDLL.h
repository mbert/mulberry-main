...
// Classes
class CEudoraAdbkIOPluginDLL : public CAdbkIOPluginDLL
{
public:

	// Actual plug-in class

	CEudoraAdbkIOPluginDLL();
	virtual ~CEudoraAdbkIOPluginDLL();
...
private:
	virtual void	AddressOut(const char* str);			// Do quote etc of friendly name
	virtual SAdbkIOPluginAddress*	AddressListParse(char* str);			// Do quote etc of friendly name
	virtual void ParseAddress(SAdbkIOPluginAddress* adr, const char* txt);		// Parse address from text
