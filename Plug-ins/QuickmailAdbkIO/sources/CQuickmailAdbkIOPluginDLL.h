...
//
// Description:
// This class implements Quickmail addressbook import DLL based plug-in for use in Mulberry.
//
// History:
// 15-Apr-1998: Created initial header and implementation.
//

#ifndef __QUICKMAILADBKIO_PLUGIN_MULBERRY__
#define __QUICKMAILADBKIO_PLUGIN_MULBERRY__

#include "CAdbkIOPluginDLL.h"

// Classes
class CQuickmailAdbkIOPluginDLL : public CAdbkIOPluginDLL
{
public:

	// Actual plug-in class

	CQuickmailAdbkIOPluginDLL();
	virtual ~CQuickmailAdbkIOPluginDLL();
