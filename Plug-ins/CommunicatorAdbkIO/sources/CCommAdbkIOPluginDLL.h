...
#ifndef __COMMUNICATORADBKIO_PLUGIN_MULBERRY__
#define __COMMUNICATORADBKIO_PLUGIN_MULBERRY__

#include "CAdbkIOPluginDLL.h"

// Classes
class CCommAdbkIOPluginDLL : public CAdbkIOPluginDLL
{
public:

	// Actual plug-in class

	CCommAdbkIOPluginDLL();
	virtual ~CCommAdbkIOPluginDLL();
...
private:
			void	WriteTypeValue(const char* type, const char* value, bool process_lines = false);
};
