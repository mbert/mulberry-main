...
public:
	...
	void LoadAppInfo(short resFile);
	void ClearAppInfo(short resFile) const;
	bool WriteAppInfo(short resFile) const;
	time_t LoadAppTimeout(short resFile) const;
	bool WriteAppTimeout(short resFile) const;
	...
	void ClearPluginInfo(short resFile) const;
	bool WritePluginInfo(short resFile, bool demo);
	...
	bool DoAppRegister(bool& demo, short resFile);
