...
CCommonViewOptions::CCommonViewOptions(LStream *inStream)
		: CTabPanel(inStream)
{
}
...
// Do various bits
void CCommonViewOptions::FinishCreateSelf()
{
	// Do inherited
	CTabPanel::FinishCreateSelf();

	mListPreview = (CUserActionOptions*) FindPaneByID(paneid_CommonViewListPreview);
	mListFullView = (CUserActionOptions*) FindPaneByID(paneid_CommonViewListFullView);
	mItemsPreview = (CUserActionOptions*) FindPaneByID(paneid_CommonViewItemsPreview);
	mItemsFullView = (CUserActionOptions*) FindPaneByID(paneid_CommonViewItemsFullView);
}
