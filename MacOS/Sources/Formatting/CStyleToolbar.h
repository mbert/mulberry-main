...
class CStyleToolbar : public LPlacard
{
	public:
		enum { class_ID = 'TENR' };
		...
		void setSizeItem(SInt16 menuItem);
		void setSize(SInt16 size);
	...
	private:
		LBevelButton *mBold;
		LBevelButton *mItalic;
		LBevelButton *mUnderline;
		LBevelButton *mAlignLeft;
		LBevelButton *mAlignCenter;
		LBevelButton *mAlignRight;
		LBevelButton *mAlignJustify;
		CFontPopup *mFont;
		CSizePopup *mSize;
		CColorPopup *mColor;
		bool here;
