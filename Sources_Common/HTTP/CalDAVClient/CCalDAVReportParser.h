...
/* 
	CCalDAVReportParser.h

	Author:			
	Description:	<describe the CCalDAVReportParser class here>
*/

#ifndef CCalDAVReportParser_H
#define CCalDAVReportParser_H
...
class CCalDAVReportParser: public CWebDAVMultiResponseParser
{
public:
	CCalDAVReportParser(iCal::CICalendar& cal);
	virtual ~CCalDAVReportParser();
...
protected:
	...
	// Calendar data
	virtual void ParseCalendarData(const xmllib::XMLNode* response, const cdstring& href, const cdstring& etag);
