...
// Source for CKSC_5601_1987 class
...
// c_2_w table data
const size_t cTableOffset1 = 0x21;
const size_t cTableOffset2 = 0x21;
const size_t cTableSize1 = 94;
...
CKSC_5601_1987::CKSC_5601_1987(bool shift)
{
	mASCIIShift = shift;
...
wchar_t CKSC_5601_1987::c_2_w(const unsigned char*& c)
{
	if (mASCIIShift)
	{
		unsigned char c1 = *c;
...
int CKSC_5601_1987::w_2_c(wchar_t wc, char* out)
{
	if (mASCIIShift)
	{
		if (wc < 0x0080)
...
wchar_t CKSC_5601_1987::tabledata(size_t i, size_t j) const
{
	return cTableData[i][j];
}

wchar_t CKSC_5601_1987::get_page_bounds(int i, int j) const
{
	return page_bounds[i][j];
}

void CKSC_5601_1987::set_page_map(int i, char* pm)
{
	page_map[i] = pm;
}

const char* CKSC_5601_1987::get_page_map(int i) const
{
	return page_map[i];
}
