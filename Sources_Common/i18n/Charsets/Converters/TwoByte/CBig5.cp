...
wchar_t CBig5::c_2_w(const unsigned char*& c)
{
	unsigned char c1 = *c++;
...
const wchar_t page_bounds[num_pages][2] =
{
	{0x0000, 0x0100},
	{0x0200, 0x0460},
	{0x2000, 0x22C0},
...
const char* page_map[num_pages] = {NULL};

int CBig5::w_2_c(wchar_t wc, char* out)
{
