...
// Source for CKSC_5601_1992 class

#include "CKSC_5601_1992.h"

using namespace i18n;

// c_2_w table data
const size_t cTableOffset1 = 0x81;
const size_t cTableOffset2 = 0x41;
const size_t cTableSize1 = 125;
const size_t cTableSize2 = 190;
const size_t cTableMax1 = cTableOffset1 + cTableSize1;
const size_t cTableMax2 = cTableOffset2 + cTableSize2;
wchar_t cTableData[cTableSize1][cTableSize2] =
{
	{	// Index 01
...
CKSC_5601_1992::CKSC_5601_1992(bool shift)
{
	mASCIIShift = shift;
	mOffset1 = cTableOffset1 + (mASCIIShift ? 0x80 : 0x00);
	mOffset2 = cTableOffset2 + (mASCIIShift ? 0x80 : 0x00);
	mSize1 = cTableSize1;
	mSize2 = cTableSize2;
	mMax1 = mOffset1 + mSize1;
	mMax2 = mOffset2 + mSize2;
	mNumPages = num_pages;
}

wchar_t CKSC_5601_1992::c_2_w(const unsigned char*& c)
{
	if (mASCIIShift)
	{
		unsigned char c1 = *c;
...
int CKSC_5601_1992::w_2_c(wchar_t wc, char* out)
{
	if (mASCIIShift)
	{
		if (wc < 0x0080)
	...
	return CCJKBase::w_2_c(wc, out);
}

wchar_t CKSC_5601_1992::tabledata(int i, int j) const
{
	return cTableData[i][j];
}

wchar_t CKSC_5601_1992::get_page_bounds(int i, int j) const
{
	return page_bounds[i][j];
}

void CKSC_5601_1992::set_page_map(int i, char* pm)
{
	page_map[i] = pm;
}

const char* CKSC_5601_1992::get_page_map(int i) const
{
	return page_map[i];
}
