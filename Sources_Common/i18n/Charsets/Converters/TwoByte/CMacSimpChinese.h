...
// Header for CMacSimpChinese class

#ifndef __CMACSIMPCHINESE__MULBERRY__
#define __CMACSIMPCHINESE__MULBERRY__
...
class CMacSimpChinese : public CCJKBase
{
public:
	CMacSimpChinese();
	virtual ~CMacSimpChinese() {}
