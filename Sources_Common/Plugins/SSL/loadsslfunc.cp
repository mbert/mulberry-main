...
IMPORT_FUNCTION_VOID(sSSLLoader, void, ASN1_STRING_free, (ASN1_STRING *a), (a))
...
IMPORT_FUNCTION(sSSLLoader, unsigned char *, MD5, (const unsigned char *d, unsigned long n, unsigned char *md), (d, n, md))
#endif
