...
JXIconTextPushButton::JXIconTextPushButton
	(
		const JCharacter* label, JXContainer* enclosure,
...
void JXIconTextPushButton::DrawBackground(JXWindowPainter& p, const JRect&	frame)
{
	bool selected = IsPushed();
...
void JXIconTextPushButton::DrawBorder(JXWindowPainter& p, const JRect&	frame)
{
	bool selected = IsPushed();
	bool enabled = IsActive();
	bool use_frame = GetBorderWidth();
