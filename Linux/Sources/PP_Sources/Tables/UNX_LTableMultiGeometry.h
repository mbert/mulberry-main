...
#ifndef _H_UNX_LTableMultiGeometry
#define _H_UNX_LTableMultiGeometry
...
public:
	...
	virtual TableIndexT	GetRowHitBy( const JPoint& inImagePt ) const;

	virtual TableIndexT	GetColHitBy( const JPoint& inImagePt ) const;
