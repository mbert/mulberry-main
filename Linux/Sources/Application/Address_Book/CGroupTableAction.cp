...
CGroupTableNewAction::CGroupTableNewAction(CGroupTable* itsTable,
												CGroup* grp,
												bool wasDirty) :
		LAction(rsrc::GetString("UI::Adbk::GroupNew_Redo"), rsrc::GetString("UI::Adbk::GroupNew_Undo"), false)
{
	mItsTable = itsTable;
...
CGroupTableEditAction::CGroupTableEditAction(CGroupTable* itsTable,
												bool wasDirty) :
		LAction(rsrc::GetString("UI::Adbk::GroupEdit_Redo"), rsrc::GetString("UI::Adbk::GroupEdit_Undo"), false)
{
	mOldItems = nil;
	mNewItems = nil;
...
CGroupTableDeleteAction::CGroupTableDeleteAction(CGroupTable* itsTable,
												...
												bool wasDirty) :
		LAction(rsrc::GetString("UI::Adbk::GroupDelete_Redo"), rsrc::GetString("UI::Adbk::GroupDelete_Undo"), false)
{
	mItsTable = itsTable;
...
{
	// Change old to new
	mItsTable->RemoveGroupsFromList(mOldItems);
	mItsTable->AddGroupsFromList(mNewItems);
}
...
void CGroupTableReplaceAction::UndoSelf()
{
	// Change new to old
	mItsTable->RemoveGroupsFromList(mNewItems);
	mItsTable->AddGroupsFromList(mOldItems);
