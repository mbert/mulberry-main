...
// Default constructor
C3PaneCalendar::C3PaneCalendar(JXContainer* enclosure,
...
// Do various bits
void C3PaneCalendar::OnCreate()
{
	// Do inherited
	C3PaneViewPanel::OnCreate();

	// Get sub-panes
	mCalendarView = new CCalendarView(this, JXWidget::kHElastic, JXWidget::kVElastic, 0, 0, 500, 200);
	mCalendarView->OnCreate();
	mCalendarView->FitToEnclosure(kTrue, kTrue);
...
unsigned int C3PaneCalendar::GetIconID() const
{
	return IDI_CALENDAR;
}
