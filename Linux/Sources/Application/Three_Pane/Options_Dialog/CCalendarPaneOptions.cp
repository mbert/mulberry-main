...
// Do various bits
void CCalendarPaneOptions::OnCreate()
{
// begin JXLayout1
    ...
    JXStaticText* obj2 =
        new JXStaticText("Calendar Store Pane", obj1,
    ...
    JXStaticText* obj3 =
        new JXStaticText("To Preview Calendars", this,
    ...
    JXStaticText* obj5 =
        new JXStaticText("To Open a Calendar", this,
                    JXWidget::kHElastic, JXWidget::kVElastic, 5,165, 145,15);
    assert( obj5 != NULL );
    obj5->SetFontSize(10);
    ...
    CDivider* obj6 =
        new CDivider(this,
                    JXWidget::kHElastic, JXWidget::kVElastic, 150,170, 45,2);
    assert( obj6 != NULL );
    ...
    JXStaticText* obj8 =
        new JXStaticText("Calendar Pane", obj7,
    ...
    JXStaticText* obj9 =
        new JXStaticText("To Preview an Item", this,
                    JXWidget::kHElastic, JXWidget::kVElastic, 205,25, 125,15);
    assert( obj9 != NULL );
    obj9->SetFontSize(10);
    ...
    CDivider* obj10 =
        new CDivider(this,
                    JXWidget::kHElastic, JXWidget::kVElastic, 330,30, 65,2);
    assert( obj10 != NULL );
    ...
    JXStaticText* obj11 =
        new JXStaticText("To Open an Item", this,
                    JXWidget::kHElastic, JXWidget::kVElastic, 205,165, 125,15);
    assert( obj11 != NULL );
    ...
    CDivider* obj12 =
        new CDivider(this,
                    JXWidget::kHElastic, JXWidget::kVElastic, 330,170, 65,2);
    assert( obj12 != NULL );
    ...
    JXStaticText* obj14 =
        new JXStaticText("Event Preview", obj13,
                    JXWidget::kHElastic, JXWidget::kVElastic, 5,5, 148,15);
    assert( obj14 != NULL );
