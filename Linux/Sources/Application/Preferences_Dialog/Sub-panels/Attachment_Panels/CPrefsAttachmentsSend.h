...
{
public:
	CPrefsAttachmentsSend(JXContainer* enclosure,
...
// begin JXLayout1
    ...
    JXSecondaryRadioGroup* mOverrideGroup;
    JXTextCheckbox*        mCheckDefaultMailClient;
    JXTextCheckbox*        mWarnMailtoFiles;
    JXTextCheckbox*        mCheckDefaultWebcalClient;
    JXTextCheckbox*        mWarnMissingAttachments;
    JXTextCheckbox*        mMissingAttachmentSubject;
    CTextInputDisplay*     mMissingAttachmentWords;
