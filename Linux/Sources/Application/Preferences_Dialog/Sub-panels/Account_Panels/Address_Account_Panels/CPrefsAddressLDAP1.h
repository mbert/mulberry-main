...
// Construction
public:
	CPrefsAddressLDAP1(JXContainer* enclosure,
...
// begin JXLayout1
    ...
    CTextInputField* mLDAPRoot;
    CTextInputField* mLDAPName;
    CTextInputField* mLDAPEmail;
    CTextInputField* mLDAPNickName;
    CTextInputField* mLDAPAddress;
    CTextInputField* mLDAPCompany;
