...
// Construction
public:
	CPrefsRemoteSets(JXContainer* enclosure,
...
// begin JXLayout1
    ...
    JXTextButton* mRefreshBtn;
    JXTextButton* mRenameBtn;
...
// end JXLayout1
	...
	virtual void Receive(JBroadcaster* sender, const Message& message);
			...
			void	UpdateList(void);						// Update list
			void	DoRefresh(void);						// Refresh remote list
			void	DoRename(void);							// Rename sets
			void	DoDelete(void);							// Delete sets
};
