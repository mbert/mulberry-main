...
{
public:
	CPrefsLetterStyled(JXContainer* enclosure,
...
// begin JXLayout1
    ...
    HPopupMenu*     mComposeAsPopup;
    JXTextCheckbox* mEnrichedPlain;
    JXTextCheckbox* mEnrichedHTML;
    JXTextCheckbox* mHTMLPlain;
    JXTextCheckbox* mHTMLEnriched;
    JXTextCheckbox* mFormatFlowed;
