...
class CBaseView : public CCommander,		// Commander must be first so it gets destroyed last
					public JXWidgetSet, public CWindowStatus, public CBroadcaster, public CListener
{
protected:
	JXWindowDirector*	mOwnerWindow;
	bool				mIs3Pane;
...
public:
	enum
	{
		...
		eBroadcast_ViewSelectionChanged = 'BVsc'
					...
					CBaseView(JXContainer* enclosure,
	...
	JXWindowDirector*	GetOwningWindow() const
		{ return mOwnerWindow; }
	bool			Is3Pane() const
		{ return mIs3Pane; }
