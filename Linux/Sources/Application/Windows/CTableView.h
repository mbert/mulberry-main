...
public:
					CTableView(JXContainer* enclosure,
...
protected:
	void	PostCreate(CTable* table, CTitleTableView* titles);

	void	SetWindowInfo(int new_col_type, short new_size, bool hierarchic)
...
public:
	...
	virtual void	SyncColumns();								// Sync column state with current set
