...
// CContainerWnd.h : header file
//

#ifndef __CCONTAINERWND__MULBERRY__
#define __CCONTAINERWND__MULBERRY__
...
{
public:
	CContainerWnd();           // protected constructor used by dynamic creation
