...
// Select one column
void CTableColumnSelector::SelectOneCell(const STableCell &inCell)
{
	// Use standard
...
// Select one column
void CTableSingleColumnSelector::SelectOneCell(const STableCell &inCell)
{
	// Use standard
	if (!CellIsSelected(inCell))
		SelectCell(inCell);
...
void CTableSingleColumnSelector::ClickSelect(const STableCell &inCell, UINT nFlags, bool one_only)
{
