...
BEGIN_MESSAGE_MAP(CAddressFieldText, CAddressFieldBase)
	ON_WM_CREATE()
END_MESSAGE_MAP()
...
const int cTextHeight = 22;
const int cTextHOffset = cPopupHOffset + cPopupWidth + 4;
const int cTextVOffset = 0;

int CAddressFieldText::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	mData.CreateEx(WS_EX_CLIENTEDGE, WS_CHILD | WS_VISIBLE | WS_BORDER | WS_TABSTOP | ES_AUTOHSCROLL | ES_AUTOHSCROLL,
...
bool CAddressFieldText::SetInitialFocus()
{
	return false;
}
