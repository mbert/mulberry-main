...
IMPLEMENT_DYNCREATE(CServerDoc, CSDIDoc)

BEGIN_MESSAGE_MAP(CServerDoc, CSDIDoc)
...
void CServerDoc::OnFileClose()
{
	POSITION pos = GetFirstViewPosition();
	CView* pView = GetNextView(pos);
	CFrameWnd* aFrame = pView->GetParentFrame();
	CServerWindow* wnd = (CServerWindow*) aFrame->GetTopWindow();
