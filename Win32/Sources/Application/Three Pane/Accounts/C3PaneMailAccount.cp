...
BEGIN_MESSAGE_MAP(C3PaneMailAccount, C3PanePanel)
	ON_WM_CREATE()
END_MESSAGE_MAP()
...
int C3PaneMailAccount::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	AddAlignment(new CWndAlignment(&mServerView, CWndAlignment::eAlign_WidthHeight));
...
{
	return const_cast<CServerView*>(&mServerView);
}
