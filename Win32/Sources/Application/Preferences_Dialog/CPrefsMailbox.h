...
/////////////////////////////////////////////////////////////////////////////
// CPrefsMailbox dialog

class CPreferences;

class CPrefsMailbox : public CPrefsPanel
{
	DECLARE_DYNCREATE(CPrefsMailbox)
...
// Dialog Data
	//{{AFX_DATA(CPrefsMailbox)
	enum { IDD = IDD_PREFS_MAILBOX };
