...
// CPrefsLocalAccount.h : header file
//
...
// Construction
public:
	CPrefsLocalAccount();   // standard constructor

// Dialog Data
	//{{AFX_DATA(CPrefsLocalAccount)
	enum { IDD = IDD_PREFS_ACCOUNT_Local };
	//}}AFX_DATA

// Overrides
	// ClassWizard generated virtual function overrides
	//{{AFX_VIRTUAL(CPrefsLocalAccount)
	//}}AFX_VIRTUAL
