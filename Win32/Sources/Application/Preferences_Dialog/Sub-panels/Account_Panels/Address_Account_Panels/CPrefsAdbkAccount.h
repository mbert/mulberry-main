...
// CPrefsAdbkAccount.h : header file
//
...
// Construction
public:
	CPrefsAdbkAccount();   // standard constructor

// Dialog Data
	//{{AFX_DATA(CPrefsAdbkAccount)
	enum { IDD = IDD_PREFS_ACCOUNT_Adbk };
	//}}AFX_DATA

// Overrides
	// ClassWizard generated virtual function overrides
	//{{AFX_VIRTUAL(CPrefsAdbkAccount)
	//}}AFX_VIRTUAL
