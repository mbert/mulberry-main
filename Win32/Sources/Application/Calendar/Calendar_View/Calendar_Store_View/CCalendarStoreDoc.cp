...
IMPLEMENT_DYNCREATE(CCalendarStoreDoc, CSDIDoc)

BEGIN_MESSAGE_MAP(CCalendarStoreDoc, CSDIDoc)
	ON_COMMAND(ID_FILE_CLOSE, OnFileClose)
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CCalendarStoreDoc commands

void CCalendarStoreDoc::OnFileClose()
{
	POSITION pos = GetFirstViewPosition();
	CView* pView = GetNextView(pos);
	CFrameWnd* aFrame = pView->GetParentFrame();
	CCalendarStoreWindow* wnd = (CCalendarStoreWindow*) aFrame->GetTopWindow();
